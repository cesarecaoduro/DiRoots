...
namespace DiRoots.Structural
{
    ...
    public static class Query
    {
        ...
        /// <returns></returns>
        [IsVisibleInDynamoLibrary(true)]
        [MultiReturn(new[] { "Curves", "PolyCurve" })]
        public static Dictionary<string, object> GetCenterLineCurves(Revit.Elements.Element Rebar, bool AdjustForSelfIntersection = true,bool SuppressHooks = true, bool SuppressBendRadius = true, bool MultiPlanarOption = true, int BarPositionIndex = 0)
        {
            string msg = "Executed";
            Rebar rebRevit = doc.GetElement(Rebar.UniqueId.ToString()) as Rebar;
            ...
            try
            {
                ...
                {
                    curves.Add(RevitToProtoCurve.ToProtoType(c));
                }
